...
class IrActionsReport(models.Model):
    ...
    report_type = fields.Selection(selection_add=[("py3o", "Py3o")], ondelete={'py3o': 'cascade'})
    ...
    def get_from_report_name(self, report_name, report_type):
        conditions = [('report_name', '=', report_name), ("report_type", "=", report_type)]
        context = self.env['res.users'].context_get()
        return self.with_context(context).sudo().search(conditions, limit=1)
