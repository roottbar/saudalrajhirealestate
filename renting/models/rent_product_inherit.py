...
class RentProduct(models.Model):
    ...
    property_analytic_account_parent = fields.Many2one(
        'account.analytic.account',  # بدل account.analytic.group
        string='Parent Analytic Account',
        related='product_rental_id.property_analytic_account_parent',  # تأكد أن property_rental_id يشير لنموذج صحيح
        store=True,)
