...
class Warehouse(models.Model):
    ...
    def create(self, vals_list):
        ...
        warehouses = super(Warehouse, self).create(vals_list)
...
# Note: stock.inventory model was removed in Odoo 16+
# Inventory adjustments are now handled through stock.quant directly
# This class has been removed to maintain Odoo 18 compatibility
