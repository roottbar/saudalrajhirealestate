...
to_19 = (
    u'صفر', u'واحد', u'اثنان', u'ثلاثة', u'أربعة', u'خمسة', u'ستة', u'سبعة', u'ثمانية', u'تسعة', u'عشرة', u'أحد عشر',
    u'اثنا عشر',
    u'ثلاثة عشر',
...
def amount_to_text_arabic(number, currency):
    ...
    if int(list[1]) > 0:
        ...
        return u'فقط ' + start_word + ' ' + _get_currency_name_by_code(currency)[0]
