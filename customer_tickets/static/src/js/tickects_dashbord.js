odoo.define('ticket.dashboard', function (require) {
"use strict";

/**
 * This file defines the tickets Dashboard view (alongside its renderer, model
 * and controller), extending the Kanban view.
 * The Ticket Dashboard view is registered to the view registry.
 * A large part of this code should be extracted in an AbstractDashboard
 * widget in web, to avoid code duplication.
 */
...
KanbanRecord.include({
     ...
     */
    _openRecord() {
        const kanbanTicketElement = this.el.querySelectorAll('.o_ticket_btn');
        if (this.selectionMode !== true && this.modelName === 'subscription.info' && kanbanTicketElement.length) {
...
var TicketDashboardRenderer = KanbanRenderer.extend({
    ...
    _render: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var helpdesk_dashboard = QWeb.render('customer_tickets.TicketDashboard', {
                widget: self,
            ...
            self.$el.parent().find(".o_ticket_dashboard").remove();
