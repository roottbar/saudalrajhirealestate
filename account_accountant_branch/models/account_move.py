...
class AccountMove(models.Model):
    ...
    def _onchange_branch_id(self):
        ...
        if move_type in self.get_sale_types(include_receipts=True):
            self.journal_id = self.branch_id.sale_journals
        elif move_type in self.get_purchase_types(include_receipts=True):
            self.journal_id = self.branch_id.purchase_journals
...
class AccountMoveLine(models.Model):
    ...
    def _get_default_analytic_account(self):
        return self.move_id.branch_id.analytic_account_id or self.env.user.branch_id.analytic_account_id
