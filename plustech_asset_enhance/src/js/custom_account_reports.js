odoo.define('plustech_asset_enhance.account_report_generic', function (require) {
'use strict';
...
var _t = core._t;
    ...
    var M2MAnalyticFilters = Widget.extend(StandaloneFieldManagerMixin, {
        /**
         * @constructor
         * @param {Object} fields
         */
    ...
    accountReportsWidget.include({
        ...
        custom_events: _.extend({}, accountReportsWidget.prototype.custom_events, {
            ...
            'value_changed': function(ev) {
                ...
                self.report_options.analytic_ids = ev.data.analytic;
                ...
                return self.reload().then(function () {
                    ...
                    self.$searchview_buttons.find('.account_anayltic_filters').click();
                });
             },
        }),
        ...
        render_searchview_buttons: function() {
            ...
            if (this.report_options.analytic) {
                ...
                if (!this.M2MAnalyticFilters) {
                    var fields = {};
                    if ('analytic_ids' in this.report_options) {
                        fields['analytic'] = {
                            label: _t('analytic'),
                            modelName: 'account.analytic.account',
                            value: this.report_options.analytic_ids.map(Number),
                        };
                    }

                    if (!_.isEmpty(fields)) {
                        this.M2MAnalyticFilters = new M2MAnalyticFilters(this, fields);
                        this.M2MAnalyticFilters.appendTo(this.$searchview_buttons.find('.js_account_analytic_m2m'));
                    }
                } else {
                    this.$searchview_buttons.find('.js_account_analytic_m2m').append(this.M2MAnalyticFilters.$el);
                }
            }
        },
