...
class SaleRentalSchedule(models.Model):
    ...
    property_id = fields.Many2one(related="product_id.property_id", store=1)
    property_address_area = fields.Many2one(related="product_id.property_id.property_address_area", store=1)
    property_address_build = fields.Many2one(related="product_id.property_id.property_address_build", store=1)
